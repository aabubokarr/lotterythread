...
80100268:	5d                   	pop    %ebp
  release(&bcache.lock);
80100269:	e9 52 46 00 00       	jmp    801048c0 <release>
    panic("brelse");
...
801003b0:	e8 fb 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 8f 7a 10 80 	movl   $0x80107a8f,(%esp)
...
80100561:	e8 4a 45 00 00       	call   80104ab0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
801005cb:	e8 50 43 00 00       	call   80104920 <acquire>
  for(i = 0; i < n; i++)
...
80100604:	e8 b7 42 00 00       	call   801048c0 <release>
  ilock(ip);
80100609:	58                   	pop    %eax
...
8010064b:	0f b6 92 e0 7a 10 80 	movzbl -0x7fef8520(%edx),%edx
...
801007fb:	e8 c0 40 00 00       	call   801048c0 <release>
...
801008b3:	e8 68 40 00 00       	call   80104920 <acquire>
  while((c = getc()) >= 0){
...
801008ed:	e8 ce 3f 00 00       	call   801048c0 <release>
  if(doprocdump) {
...
80100a2c:	e8 5f 37 00 00       	call   80104190 <wakeup>
...
80100a4f:	e9 ec 3a 00 00       	jmp    80104540 <procdump>
80100a54:	fa                   	cli
    for(;;)
...
80100cca:	e8 41 3f 00 00       	call   80104c10 <strlen>
...
80100cd8:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100cdb:	e8 30 3f 00 00       	call   80104c10 <strlen>
...
80100d9f:	e8 2c 3e 00 00       	call   80104bd0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100e40:	e8 eb 38 00 00       	call   80104730 <initlock>
}
...
80100e61:	e8 ba 3a 00 00       	call   80104920 <acquire>
...
80100e91:	e8 2a 3a 00 00       	call   801048c0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100eaa:	e8 11 3a 00 00       	call   801048c0 <release>
}
...
80100ecf:	e8 4c 3a 00 00       	call   80104920 <acquire>
  if(f->ref < 1)
...
80100eec:	e8 cf 39 00 00       	call   801048c0 <release>
  return f;
}
...
80100f21:	e8 fa 39 00 00       	call   80104920 <acquire>
  if(f->ref < 1)
...
80100f5c:	e8 5f 39 00 00       	call   801048c0 <release>
...
80100f8d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f8e:	e9 2d 39 00 00       	jmp    801048c0 <release>
...
801012cd:	e8 4e 37 00 00       	call   80104a20 <memset>
  log_write(bp);
...
8010130a:	e8 11 36 00 00       	call   80104920 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101377:	e8 44 35 00 00       	call   801048c0 <release>
...
801013a5:	e8 16 35 00 00       	call   801048c0 <release>
      return ip;
...
80101561:	e8 4a 35 00 00       	call   80104ab0 <memmove>
  brelse(bp);
...
80101596:	e8 95 31 00 00       	call   80104730 <initlock>
  for(i = 0; i < NINODE; i++) {
...
801015a9:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
801015af:	e8 4c 30 00 00       	call   80104600 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015dc:	e8 cf 34 00 00       	call   80104ab0 <memmove>
  brelse(bp);
...
80101613:	68 f4 7a 10 80       	push   $0x80107af4
...
801016ae:	e8 6d 33 00 00       	call   80104a20 <memset>
      dip->type = type;
...
80101751:	e8 5a 33 00 00       	call   80104ab0 <memmove>
  log_write(bp);
...
8010177f:	e8 9c 31 00 00       	call   80104920 <acquire>
  ip->ref++;
80101784:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101788:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010178f:	e8 2c 31 00 00       	call   801048c0 <release>
}
...
801017c2:	e8 79 2e 00 00       	call   80104640 <acquiresleep>
  if(ip->valid == 0){
...
80101838:	e8 73 32 00 00       	call   80104ab0 <memmove>
    brelse(bp);
...
80101893:	e8 48 2e 00 00       	call   801046e0 <holdingsleep>
...
801018ae:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801018af:	e9 ec 2d 00 00       	jmp    801046a0 <releasesleep>
    panic("iunlock");
...
801018e0:	e8 5b 2d 00 00       	call   80104640 <acquiresleep>
...
801018fa:	e8 a1 2d 00 00       	call   801046a0 <releasesleep>
  acquire(&icache.lock);
801018ff:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101906:	e8 15 30 00 00       	call   80104920 <acquire>
  ip->ref--;
...
80101a43:	e8 98 2c 00 00       	call   801046e0 <holdingsleep>
...
80101a5a:	e8 41 2c 00 00       	call   801046a0 <releasesleep>
  iput(ip);
...
80101b57:	e8 54 2f 00 00       	call   80104ab0 <memmove>
    brelse(bp);
...
80101c55:	e8 56 2e 00 00       	call   80104ab0 <memmove>
    log_write(bp);
...
80101cde:	e8 3d 2e 00 00       	call   80104b20 <strncmp>
}
80101ce3:	c9                   	leave
80101ce4:	c3                   	ret
...
80101d3d:	e8 de 2d 00 00       	call   80104b20 <strncmp>
      continue;
...
80101dca:	e8 51 2b 00 00       	call   80104920 <acquire>
  ip->ref++;
80101dcf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dd3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dda:	e8 e1 2a 00 00       	call   801048c0 <release>
...
80101e37:	e8 74 2c 00 00       	call   80104ab0 <memmove>
...
80101e9c:	e8 3f 28 00 00       	call   801046e0 <holdingsleep>
...
80101ebe:	e8 dd 27 00 00       	call   801046a0 <releasesleep>
  iput(ip);
...
80101eeb:	e8 c0 2b 00 00       	call   80104ab0 <memmove>
    name[len] = 0;
...
80101f25:	e8 b6 27 00 00       	call   801046e0 <holdingsleep>
...
80101f3c:	e8 5f 27 00 00       	call   801046a0 <releasesleep>
  iput(ip);
...
80101f75:	e8 66 27 00 00       	call   801046e0 <holdingsleep>
...
80101f8c:	e8 0f 27 00 00       	call   801046a0 <releasesleep>
}
...
8010201d:	e8 4e 2b 00 00       	call   80104b70 <strncpy>
  de.inum = inum;
...
80102068:	68 93 79 10 80       	push   $0x80107993
...
801021b0:	e8 7b 25 00 00       	call   80104730 <initlock>
...
8010223e:	e8 dd 26 00 00       	call   80104920 <acquire>
...
8010229d:	e8 ee 1e 00 00       	call   80104190 <wakeup>
...
801022bb:	e8 00 26 00 00       	call   801048c0 <release>
...
801022de:	e8 fd 23 00 00       	call   801046e0 <holdingsleep>
...
80102318:	e8 03 26 00 00       	call   80104920 <acquire>
...
80102359:	e8 72 1d 00 00       	call   801040d0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102375:	c9                   	leave
  release(&idelock);
80102376:	e9 45 25 00 00       	jmp    801048c0 <release>
...
8010240a:	68 48 7b 10 80       	push   $0x80107b48
...
801024d2:	e8 49 25 00 00       	call   80104a20 <memset>
...
80102508:	e8 13 24 00 00       	call   80104920 <acquire>
...
80102522:	c9                   	leave
    release(&kmem.lock);
80102523:	e9 98 23 00 00       	jmp    801048c0 <release>
    panic("kfree");
...
80102605:	e8 26 21 00 00       	call   80104730 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102698:	e8 83 22 00 00       	call   80104920 <acquire>
  r = kmem.freelist;
...
801026c3:	e8 f8 21 00 00       	call   801048c0 <release>
}
...
80102ad3:	e8 88 1f 00 00       	call   80104a60 <memcmp>
...
80102c04:	e8 a7 1e 00 00       	call   80104ab0 <memmove>
...
80102cb4:	e8 77 1a 00 00       	call   80104730 <initlock>
  readsb(dev, &sb);
80102cb9:	58                   	pop    %eax
...
80102d4b:	e8 d0 1b 00 00       	call   80104920 <acquire>
...
80102d65:	e8 66 13 00 00       	call   801040d0 <sleep>
...
80102dbe:	e8 5d 1b 00 00       	call   80104920 <acquire>
  log.outstanding -= 1;
...
80102e94:	e8 17 1c 00 00       	call   80104ab0 <memmove>
...
80102ee8:	e8 a3 12 00 00       	call   80104190 <wakeup>
  release(&log.lock);
80102eed:	c7 04 24 a0 16 11 80 	movl   $0x801116a0,(%esp)
80102ef4:	e8 c7 19 00 00       	call   801048c0 <release>
...
80102f52:	e8 c9 19 00 00       	call   80104920 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102f98:	c9                   	leave
  release(&log.lock);
80102f99:	e9 22 19 00 00       	jmp    801048c0 <release>
...
8010300a:	e8 61 0c 00 00       	call   80103c70 <scheduler>
8010300f:	90                   	nop
...
801030a4:	e8 07 1a 00 00       	call   80104ab0 <memmove>
...
80103194:	e8 c7 18 00 00       	call   80104a60 <memcmp>
...
8010325b:	e8 00 18 00 00       	call   80104a60 <memcmp>
...
801033bc:	e8 9f 16 00 00       	call   80104a60 <memcmp>
...
801033eb:	68 7c 7b 10 80       	push   $0x80107b7c
...
80103499:	e8 92 12 00 00       	call   80104730 <initlock>
  (*f0)->type = FD_PIPE;
...
8010351f:	e8 fc 13 00 00       	call   80104920 <acquire>
  if(writable){
...
80103563:	5d                   	pop    %ebp
    release(&p->lock);
80103564:	e9 57 13 00 00       	jmp    801048c0 <release>
...
801035a4:	e8 e7 0b 00 00       	call   80104190 <wakeup>
...
801035c0:	e8 5b 13 00 00       	call   80104920 <acquire>
  for(i = 0; i < n; i++){
...
80103620:	e8 6b 0b 00 00       	call   80104190 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103625:	58                   	pop    %eax
80103626:	5a                   	pop    %edx
80103627:	53                   	push   %ebx
80103628:	57                   	push   %edi
80103629:	e8 a2 0a 00 00       	call   801040d0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103654:	e8 67 12 00 00       	call   801048c0 <release>
        return -1;
...
801036a8:	e8 e3 0a 00 00       	call   80104190 <wakeup>
  release(&p->lock);
801036ad:	89 1c 24             	mov    %ebx,(%esp)
801036b0:	e8 0b 12 00 00       	call   801048c0 <release>
  return n;
...
80103807:	89 15 08 a0 10 80    	mov    %edx,0x8010a008
  release(&ptable.lock);
8010380d:	e8 ae 10 00 00       	call   801048c0 <release>
...
8010382f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103832:	c7 40 14 cf 5c 10 80 	movl   $0x80105ccf,0x14(%eax)
  p->context = (struct context*)sp;
...
80103841:	e8 da 11 00 00       	call   80104a20 <memset>
...
8010389b:	e8 20 10 00 00       	call   801048c0 <release>
...
801038e6:	68 36 78 10 80       	push   $0x80107836
801038eb:	68 20 1d 11 80       	push   $0x80111d20
801038f0:	e8 3b 0e 00 00       	call   80104730 <initlock>
}
...
80103a4f:	68 66 78 10 80       	push   $0x80107866
80103a54:	50                   	push   %eax
80103a55:	e8 76 11 00 00       	call   80104bd0 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 6f 78 10 80 	movl   $0x8010786f,(%esp)
...
80103a93:	68 4d 78 10 80       	push   $0x8010784d
...
80103aea:	e8 e1 35 00 00       	call   801070d0 <allocuvm>
...
80103b0a:	e8 e1 36 00 00       	call   801071f0 <deallocuvm>
...
80103bb9:	e8 b2 db ff ff       	call   80101770 <idup>
...
80103bd1:	e8 fa 0f 00 00       	call   80104bd0 <safestrcpy>
  np->tickets = curproc->tickets; // Copy tickets
80103bd6:	8b 43 7c             	mov    0x7c(%ebx),%eax
  pid = np->pid;
80103bd9:	8b 5f 10             	mov    0x10(%edi),%ebx
  np->tickets = curproc->tickets; // Copy tickets
80103bdc:	89 47 7c             	mov    %eax,0x7c(%edi)
  acquire(&ptable.lock);
80103bdf:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103be6:	e8 35 0d 00 00       	call   80104920 <acquire>
  np->state = RUNNABLE;
80103beb:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103bf2:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103bf9:	e8 c2 0c 00 00       	call   801048c0 <release>
  return pid;
...
80103c0a:	c3                   	ret
    kfree(np->kstack);
80103c0b:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103c0e:	83 ec 0c             	sub    $0xc,%esp
80103c11:	ff 73 08             	push   0x8(%ebx)
80103c14:	e8 87 e8 ff ff       	call   801024a0 <kfree>
    np->kstack = 0;
80103c19:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    return -1;
80103c20:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103c23:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103c2a:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103c2f:	eb d0                	jmp    80103c01 <fork+0xe1>
80103c31:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80103c38:	00 
80103c39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80103c40 <random>:
  seed = (seed * 1103515245 + 12345) & 0x7fffffff;
80103c40:	69 05 04 a0 10 80 6d 	imul   $0x41c64e6d,0x8010a004,%eax
80103c47:	4e c6 41 
{
...
80103c4b:	31 d2                	xor    %edx,%edx
  seed = (seed * 1103515245 + 12345) & 0x7fffffff;
80103c4d:	05 39 30 00 00       	add    $0x3039,%eax
{
80103c52:	89 e5                	mov    %esp,%ebp
  seed = (seed * 1103515245 + 12345) & 0x7fffffff;
80103c54:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
80103c59:	a3 04 a0 10 80       	mov    %eax,0x8010a004
  return seed % max;
80103c5e:	f7 75 08             	divl   0x8(%ebp)
}
80103c61:	5d                   	pop    %ebp
80103c62:	89 d0                	mov    %edx,%eax
80103c64:	c3                   	ret
80103c65:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80103c6c:	00 
...
80103c76:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103c79:	e8 82 fc ff ff       	call   80103900 <mycpu>
  c->proc = 0;
...
80103c99:	e8 82 0c 00 00       	call   80104920 <acquire>
80103c9e:	83 c4 10             	add    $0x10,%esp
    int total_tickets = 0;
80103ca1:	31 c9                	xor    %ecx,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103cb4:	75 03                	jne    80103cb9 <scheduler+0x49>
        total_tickets += p->tickets;
80103cb6:	03 48 7c             	add    0x7c(%eax),%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb9:	83 e8 80             	sub    $0xffffff80,%eax
80103cbc:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103cc1:	75 ed                	jne    80103cb0 <scheduler+0x40>
    if(total_tickets > 0){
80103cc3:	85 c9                	test   %ecx,%ecx
80103cc5:	7e 74                	jle    80103d3b <scheduler+0xcb>
  seed = (seed * 1103515245 + 12345) & 0x7fffffff;
80103cc7:	69 05 04 a0 10 80 6d 	imul   $0x41c64e6d,0x8010a004,%eax
80103cce:	4e c6 41 
  return seed % max;
80103cd1:	31 d2                	xor    %edx,%edx
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cd3:	bf 54 1d 11 80       	mov    $0x80111d54,%edi
  seed = (seed * 1103515245 + 12345) & 0x7fffffff;
80103cd8:	05 39 30 00 00       	add    $0x3039,%eax
80103cdd:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
80103ce2:	a3 04 a0 10 80       	mov    %eax,0x8010a004
  return seed % max;
80103ce7:	f7 f1                	div    %ecx
      int current_tickets = 0;
80103ce9:	31 c0                	xor    %eax,%eax
80103ceb:	eb 0e                	jmp    80103cfb <scheduler+0x8b>
80103ced:	8d 76 00             	lea    0x0(%esi),%esi
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cf0:	83 ef 80             	sub    $0xffffff80,%edi
80103cf3:	81 ff 54 3d 11 80    	cmp    $0x80113d54,%edi
80103cf9:	74 40                	je     80103d3b <scheduler+0xcb>
        if(p->state != RUNNABLE)
80103cfb:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103cff:	75 ef                	jne    80103cf0 <scheduler+0x80>
        current_tickets += p->tickets;
80103d01:	03 47 7c             	add    0x7c(%edi),%eax
        if(current_tickets > winner){
80103d04:	39 d0                	cmp    %edx,%eax
80103d06:	7e e8                	jle    80103cf0 <scheduler+0x80>
          switchuvm(p);
80103d08:	83 ec 0c             	sub    $0xc,%esp
          c->proc = p;
80103d0b:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
          switchuvm(p);
80103d11:	57                   	push   %edi
80103d12:	e8 59 31 00 00       	call   80106e70 <switchuvm>
          swtch(&(c->scheduler), p->context);
80103d17:	58                   	pop    %eax
80103d18:	5a                   	pop    %edx
80103d19:	ff 77 1c             	push   0x1c(%edi)
80103d1c:	56                   	push   %esi
          p->state = RUNNING;
80103d1d:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
          swtch(&(c->scheduler), p->context);
80103d24:	e8 02 0f 00 00       	call   80104c2b <swtch>
          switchkvm();
80103d29:	e8 32 31 00 00       	call   80106e60 <switchkvm>
          break;
80103d2e:	83 c4 10             	add    $0x10,%esp
          c->proc = 0;
80103d31:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103d38:	00 00 00 
    release(&ptable.lock);
80103d3b:	83 ec 0c             	sub    $0xc,%esp
80103d3e:	68 20 1d 11 80       	push   $0x80111d20
80103d43:	e8 78 0b 00 00       	call   801048c0 <release>
  for(;;){
80103d48:	83 c4 10             	add    $0x10,%esp
80103d4b:	e9 40 ff ff ff       	jmp    80103c90 <scheduler+0x20>
...
80103d72:	e8 09 0b 00 00       	call   80104880 <holding>
...
80103db3:	e8 73 0e 00 00       	call   80104c2b <swtch>
  mycpu()->intena = intena;
...
80103e19:	e8 62 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103e1e:	39 05 54 3d 11 80    	cmp    %eax,0x80113d54
...
80103e42:	e8 c9 d0 ff ff       	call   80100f10 <fileclose>
      curproc->ofile[fd] = 0;
...
80103e55:	75 e1                	jne    80103e38 <exit+0x28>
  begin_op();
80103e57:	e8 e4 ee ff ff       	call   80102d40 <begin_op>
  iput(curproc->cwd);
80103e5c:	83 ec 0c             	sub    $0xc,%esp
80103e5f:	ff 73 68             	push   0x68(%ebx)
80103e62:	e8 69 da ff ff       	call   801018d0 <iput>
  end_op();
80103e67:	e8 44 ef ff ff       	call   80102db0 <end_op>
  curproc->cwd = 0;
80103e6c:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103e73:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103e7a:	e8 a1 0a 00 00       	call   80104920 <acquire>
...
80103eaf:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103eb4:	75 e4                	jne    80103e9a <exit+0x8a>
      p->parent = initproc;
80103eb6:	8b 0d 54 3d 11 80    	mov    0x80113d54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ebc:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
80103ec1:	eb 10                	jmp    80103ed3 <exit+0xc3>
80103ec3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
80103ec8:	83 ea 80             	sub    $0xffffff80,%edx
80103ecb:	81 fa 54 3d 11 80    	cmp    $0x80113d54,%edx
...
80103edf:	75 e7                	jne    80103ec8 <exit+0xb8>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ee1:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103ee6:	eb 12                	jmp    80103efa <exit+0xea>
80103ee8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80103eef:	00 
80103ef0:	83 e8 80             	sub    $0xffffff80,%eax
80103ef3:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
...
80103f1d:	68 be 78 10 80       	push   $0x801078be
80103f22:	e8 59 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f27:	83 ec 0c             	sub    $0xc,%esp
80103f2a:	68 b1 78 10 80       	push   $0x801078b1
80103f2f:	e8 4c c4 ff ff       	call   80100380 <panic>
80103f34:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80103f3b:	00 
...
80103f62:	e8 b9 09 00 00       	call   80104920 <acquire>
...
80103f7b:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
80103f81:	74 23                	je     80103fa6 <wait+0x66>
...
80103f88:	8b 56 04             	mov    0x4(%esi),%edx
80103f8b:	39 53 04             	cmp    %edx,0x4(%ebx)
80103f8e:	74 e8                	je     80103f78 <wait+0x38>
      if(p->state == ZOMBIE){
80103f90:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103f94:	74 62                	je     80103ff8 <wait+0xb8>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f96:	83 eb 80             	sub    $0xffffff80,%ebx
      havekids = 1;
80103f99:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f9e:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
80103fa4:	75 dd                	jne    80103f83 <wait+0x43>
    if(!havekids || curproc->killed){
80103fa6:	85 c0                	test   %eax,%eax
80103fa8:	0f 84 a0 00 00 00    	je     8010404e <wait+0x10e>
80103fae:	8b 46 24             	mov    0x24(%esi),%eax
80103fb1:	85 c0                	test   %eax,%eax
80103fb3:	0f 85 95 00 00 00    	jne    8010404e <wait+0x10e>
  pushcli();
80103fb9:	e8 12 08 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80103fbe:	e8 3d f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103fc3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fc9:	e8 52 08 00 00       	call   80104820 <popcli>
  if(p == 0)
80103fce:	85 db                	test   %ebx,%ebx
80103fd0:	0f 84 8f 00 00 00    	je     80104065 <wait+0x125>
  p->chan = chan;
80103fd6:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80103fd9:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103fe0:	e8 6b fd ff ff       	call   80103d50 <sched>
  p->chan = 0;
80103fe5:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80103fec:	e9 79 ff ff ff       	jmp    80103f6a <wait+0x2a>
...
80103ffb:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103ffe:	ff 73 08             	push   0x8(%ebx)
80104001:	e8 9a e4 ff ff       	call   801024a0 <kfree>
        p->kstack = 0;
80104006:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
8010400d:	5a                   	pop    %edx
8010400e:	ff 73 04             	push   0x4(%ebx)
80104011:	e8 0a 32 00 00       	call   80107220 <freevm>
        p->pid = 0;
80104016:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
8010401d:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80104024:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104028:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
8010402f:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104036:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010403d:	e8 7e 08 00 00       	call   801048c0 <release>
        return pid;
...
80104051:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104056:	68 20 1d 11 80       	push   $0x80111d20
8010405b:	e8 60 08 00 00       	call   801048c0 <release>
      return -1;
80104060:	83 c4 10             	add    $0x10,%esp
80104063:	eb e0                	jmp    80104045 <wait+0x105>
    panic("sleep");
80104065:	83 ec 0c             	sub    $0xc,%esp
80104068:	68 ca 78 10 80       	push   $0x801078ca
8010406d:	e8 0e c3 ff ff       	call   80100380 <panic>
80104072:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104079:	00 
...
8010408c:	e8 8f 08 00 00       	call   80104920 <acquire>
  pushcli();
80104091:	e8 3a 07 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80104096:	e8 65 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010409b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040a1:	e8 7a 07 00 00       	call   80104820 <popcli>
  myproc()->state = RUNNABLE;
801040a6:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
801040ad:	e8 9e fc ff ff       	call   80103d50 <sched>
  release(&ptable.lock);
801040b2:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801040b9:	e8 02 08 00 00       	call   801048c0 <release>
}
...
801040dc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801040df:	e8 ec 06 00 00       	call   801047d0 <pushcli>
  c = mycpu();
801040e4:	e8 17 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801040e9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040ef:	e8 2c 07 00 00       	call   80104820 <popcli>
  if(p == 0)
...
8010414b:	5d                   	pop    %ebp
    acquire(lk);
8010414c:	e9 cf 07 00 00       	jmp    80104920 <acquire>
...
8010415b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104162:	e8 e9 fb ff ff       	call   80103d50 <sched>
  p->chan = 0;
...
80104179:	68 d0 78 10 80       	push   $0x801078d0
8010417e:	e8 fd c1 ff ff       	call   80100380 <panic>
    panic("sleep");
80104183:	83 ec 0c             	sub    $0xc,%esp
80104186:	68 ca 78 10 80       	push   $0x801078ca
...
8010419f:	e8 7c 07 00 00       	call   80104920 <acquire>
...
801041c5:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041cc:	83 e8 80             	sub    $0xffffff80,%eax
801041cf:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
801041d4:	75 e4                	jne    801041ba <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
801041d6:	c7 45 08 20 1d 11 80 	movl   $0x80111d20,0x8(%ebp)
}
801041dd:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801041e0:	c9                   	leave
  release(&ptable.lock);
801041e1:	e9 da 06 00 00       	jmp    801048c0 <release>
...
801041ff:	e8 1c 07 00 00       	call   80104920 <acquire>
...
80104210:	83 e8 80             	sub    $0xffffff80,%eax
80104213:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80104218:	74 36                	je     80104250 <kill+0x60>
    if(p->pid == pid){
...
80104236:	68 20 1d 11 80       	push   $0x80111d20
8010423b:	e8 80 06 00 00       	call   801048c0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104258:	e8 63 06 00 00       	call   801048c0 <release>
}
...
8010427a:	7e 44                	jle    801042c0 <settickets+0x50>
    return -1;
  acquire(&ptable.lock);
8010427c:	83 ec 0c             	sub    $0xc,%esp
8010427f:	68 20 1d 11 80       	push   $0x80111d20
80104284:	e8 97 06 00 00       	call   80104920 <acquire>
  pushcli();
80104289:	e8 42 05 00 00       	call   801047d0 <pushcli>
  c = mycpu();
8010428e:	e8 6d f6 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104293:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104299:	e8 82 05 00 00       	call   80104820 <popcli>
  myproc()->tickets = number;
8010429e:	89 5e 7c             	mov    %ebx,0x7c(%esi)
  release(&ptable.lock);
801042a1:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801042a8:	e8 13 06 00 00       	call   801048c0 <release>
  return 0;
801042ad:	83 c4 10             	add    $0x10,%esp
801042b0:	31 c0                	xor    %eax,%eax
}
801042b2:	8d 65 f8             	lea    -0x8(%ebp),%esp
801042b5:	5b                   	pop    %ebx
801042b6:	5e                   	pop    %esi
801042b7:	5d                   	pop    %ebp
801042b8:	c3                   	ret
...
801042c5:	eb eb                	jmp    801042b2 <settickets+0x42>
801042c7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801042ce:	00 
801042cf:	90                   	nop
...
801042d6:	83 ec 2c             	sub    $0x2c,%esp
  pushcli();
801042d9:	e8 f2 04 00 00       	call   801047d0 <pushcli>
  c = mycpu();
801042de:	e8 1d f6 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801042e3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801042e9:	e8 32 05 00 00       	call   80104820 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
  ...
  // Allocate process.
  if((np = allocproc()) == 0){
801042ee:	e8 bd f4 ff ff       	call   801037b0 <allocproc>
801042f3:	85 c0                	test   %eax,%eax
801042f5:	0f 84 fc 00 00 00    	je     801043f7 <clone+0x127>
801042fb:	89 c2                	mov    %eax,%edx
    return -1;
  }

  // Share address space
  np->pgdir = curproc->pgdir;
801042fd:	8b 43 04             	mov    0x4(%ebx),%eax
  np->sz = curproc->sz;
  np->parent = curproc;
  *np->tf = *curproc->tf;
80104300:	b9 13 00 00 00       	mov    $0x13,%ecx
80104305:	8b 7a 18             	mov    0x18(%edx),%edi
  np->pgdir = curproc->pgdir;
80104308:	89 42 04             	mov    %eax,0x4(%edx)
  np->sz = curproc->sz;
8010430b:	8b 03                	mov    (%ebx),%eax
  np->parent = curproc;
8010430d:	89 5a 14             	mov    %ebx,0x14(%edx)
  np->sz = curproc->sz;
80104310:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
80104312:	8b 73 18             	mov    0x18(%ebx),%esi
80104315:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  ...
  uint ustack[3];
  ustack[0] = 0xffffffff; // fake return PC
80104317:	c7 45 dc ff ff ff ff 	movl   $0xffffffff,-0x24(%ebp)
  np->tf->eax = 0;
8010431e:	8b 42 18             	mov    0x18(%edx),%eax
80104321:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  ustack[1] = (uint)arg1;
80104328:	8b 45 0c             	mov    0xc(%ebp),%eax
8010432b:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ustack[2] = (uint)arg2;
8010432e:	8b 45 10             	mov    0x10(%ebp),%eax
80104331:	89 45 e4             	mov    %eax,-0x1c(%ebp)

  uint esp = (uint)stack + 4096; // Assume stack is one page
  esp -= 12;
80104334:	8b 45 14             	mov    0x14(%ebp),%eax
  if(copyout(np->pgdir, esp, ustack, 12) < 0) {
80104337:	6a 0c                	push   $0xc
  esp -= 12;
80104339:	8d b0 f4 0f 00 00    	lea    0xff4(%eax),%esi
  if(copyout(np->pgdir, esp, ustack, 12) < 0) {
8010433f:	8d 45 dc             	lea    -0x24(%ebp),%eax
80104342:	50                   	push   %eax
80104343:	56                   	push   %esi
80104344:	ff 72 04             	push   0x4(%edx)
80104347:	89 55 d4             	mov    %edx,-0x2c(%ebp)
8010434a:	e8 c1 31 00 00       	call   80107510 <copyout>
8010434f:	83 c4 10             	add    $0x10,%esp
80104352:	85 c0                	test   %eax,%eax
80104354:	0f 88 9d 00 00 00    	js     801043f7 <clone+0x127>
    // Should clean up np
    return -1;
  }

  np->tf->esp = esp;
8010435a:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  np->tf->eip = (uint)fcn;
8010435d:	8b 4d 08             	mov    0x8(%ebp),%ecx
  np->tf->esp = esp;
80104360:	8b 42 18             	mov    0x18(%edx),%eax
80104363:	89 70 44             	mov    %esi,0x44(%eax)
  np->tf->eip = (uint)fcn;
80104366:	8b 42 18             	mov    0x18(%edx),%eax

  for(i = 0; i < NOFILE; i++)
80104369:	31 f6                	xor    %esi,%esi
  np->tf->eip = (uint)fcn;
8010436b:	89 48 38             	mov    %ecx,0x38(%eax)
  for(i = 0; i < NOFILE; i++)
8010436e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[i])
80104370:	8b 44 b3 28          	mov    0x28(%ebx,%esi,4),%eax
80104374:	85 c0                	test   %eax,%eax
80104376:	74 16                	je     8010438e <clone+0xbe>
      np->ofile[i] = filedup(curproc->ofile[i]);
80104378:	83 ec 0c             	sub    $0xc,%esp
8010437b:	89 55 d4             	mov    %edx,-0x2c(%ebp)
8010437e:	50                   	push   %eax
8010437f:	e8 3c cb ff ff       	call   80100ec0 <filedup>
80104384:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80104387:	83 c4 10             	add    $0x10,%esp
8010438a:	89 44 b2 28          	mov    %eax,0x28(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
8010438e:	83 c6 01             	add    $0x1,%esi
80104391:	83 fe 10             	cmp    $0x10,%esi
80104394:	75 da                	jne    80104370 <clone+0xa0>
  np->cwd = idup(curproc->cwd);
80104396:	83 ec 0c             	sub    $0xc,%esp
80104399:	89 55 d4             	mov    %edx,-0x2c(%ebp)
8010439c:	ff 73 68             	push   0x68(%ebx)
8010439f:	e8 cc d3 ff ff       	call   80101770 <idup>
801043a4:	8b 55 d4             	mov    -0x2c(%ebp),%edx

  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801043a7:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
801043aa:	89 42 68             	mov    %eax,0x68(%edx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801043ad:	8d 43 6c             	lea    0x6c(%ebx),%eax
801043b0:	6a 10                	push   $0x10
801043b2:	50                   	push   %eax
801043b3:	8d 42 6c             	lea    0x6c(%edx),%eax
801043b6:	50                   	push   %eax
801043b7:	e8 14 08 00 00       	call   80104bd0 <safestrcpy>
  np->tickets = curproc->tickets;
801043bc:	8b 43 7c             	mov    0x7c(%ebx),%eax
801043bf:	8b 55 d4             	mov    -0x2c(%ebp),%edx
801043c2:	89 42 7c             	mov    %eax,0x7c(%edx)

  pid = np->pid;
801043c5:	8b 5a 10             	mov    0x10(%edx),%ebx

  acquire(&ptable.lock);
801043c8:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801043cf:	e8 4c 05 00 00       	call   80104920 <acquire>
  np->state = RUNNABLE;
801043d4:	8b 55 d4             	mov    -0x2c(%ebp),%edx
801043d7:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  release(&ptable.lock);
801043de:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801043e5:	e8 d6 04 00 00       	call   801048c0 <release>
...
801043f6:	c3                   	ret
    return -1;
801043f7:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801043fc:	eb ef                	jmp    801043ed <clone+0x11d>
...
80104409:	8b 7d 08             	mov    0x8(%ebp),%edi
  pushcli();
8010440c:	e8 bf 03 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80104411:	e8 ea f4 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104416:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
8010441c:	e8 ff 03 00 00       	call   80104820 <popcli>
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80104424:	68 20 1d 11 80       	push   $0x80111d20
80104429:	e8 f2 04 00 00       	call   80104920 <acquire>
...
80104431:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104433:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
80104438:	eb 11                	jmp    8010444b <join+0x4b>
8010443a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104440:	83 eb 80             	sub    $0xffffff80,%ebx
80104443:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
80104449:	74 23                	je     8010446e <join+0x6e>
      if(p->parent != curproc || p->pgdir != curproc->pgdir)
8010444b:	39 73 14             	cmp    %esi,0x14(%ebx)
8010444e:	75 f0                	jne    80104440 <join+0x40>
80104450:	8b 56 04             	mov    0x4(%esi),%edx
80104453:	39 53 04             	cmp    %edx,0x4(%ebx)
80104456:	75 e8                	jne    80104440 <join+0x40>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
80104458:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010445c:	74 62                	je     801044c0 <join+0xc0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
8010446c:	75 dd                	jne    8010444b <join+0x4b>
        release(&ptable.lock);
        return pid;
      }
    }
...
80104470:	0f 84 a4 00 00 00    	je     8010451a <join+0x11a>
80104476:	8b 46 24             	mov    0x24(%esi),%eax
80104479:	85 c0                	test   %eax,%eax
8010447b:	0f 85 99 00 00 00    	jne    8010451a <join+0x11a>
  pushcli();
80104481:	e8 4a 03 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80104486:	e8 75 f4 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010448b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104491:	e8 8a 03 00 00       	call   80104820 <popcli>
  if(p == 0)
80104496:	85 db                	test   %ebx,%ebx
80104498:	0f 84 93 00 00 00    	je     80104531 <join+0x131>
  p->chan = chan;
8010449e:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
801044a1:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801044a8:	e8 a3 f8 ff ff       	call   80103d50 <sched>
  p->chan = 0;
801044ad:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
801044b4:	e9 78 ff ff ff       	jmp    80104431 <join+0x31>
801044b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        pid = p->pid;
801044c0:	8b 73 10             	mov    0x10(%ebx),%esi
        if(stack != 0)
801044c3:	85 ff                	test   %edi,%edi
801044c5:	74 08                	je     801044cf <join+0xcf>
           *stack = (void*)p->tf->ebp; // This is a simplification
801044c7:	8b 43 18             	mov    0x18(%ebx),%eax
801044ca:	8b 40 08             	mov    0x8(%eax),%eax
801044cd:	89 07                	mov    %eax,(%edi)
        kfree(p->kstack);
801044cf:	83 ec 0c             	sub    $0xc,%esp
801044d2:	ff 73 08             	push   0x8(%ebx)
801044d5:	e8 c6 df ff ff       	call   801024a0 <kfree>
        p->kstack = 0;
801044da:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        p->pid = 0;
801044e1:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
801044e8:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801044ef:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
801044f3:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
801044fa:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104501:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80104508:	e8 b3 03 00 00       	call   801048c0 <release>
        return pid;
...
8010451a:	83 ec 0c             	sub    $0xc,%esp
      return -1;
8010451d:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104522:	68 20 1d 11 80       	push   $0x80111d20
80104527:	e8 94 03 00 00       	call   801048c0 <release>
      return -1;
8010452c:	83 c4 10             	add    $0x10,%esp
8010452f:	eb df                	jmp    80104510 <join+0x110>
    panic("sleep");
80104531:	83 ec 0c             	sub    $0xc,%esp
80104534:	68 ca 78 10 80       	push   $0x801078ca
80104539:	e8 42 be ff ff       	call   80100380 <panic>
...
8010455b:	68 8f 7a 10 80       	push   $0x80107a8f
80104560:	e8 4b c1 ff ff       	call   801006b0 <cprintf>
80104565:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104568:	83 eb 80             	sub    $0xffffff80,%ebx
8010456b:	81 fb c0 3d 11 80    	cmp    $0x80113dc0,%ebx
...
8010457c:	74 ea                	je     80104568 <procdump+0x28>
      state = "???";
8010457e:	ba e1 78 10 80       	mov    $0x801078e1,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104583:	83 f8 05             	cmp    $0x5,%eax
80104586:	77 11                	ja     80104599 <procdump+0x59>
80104588:	8b 14 85 c0 7e 10 80 	mov    -0x7fef8140(,%eax,4),%edx
      state = "???";
8010458f:	b8 e1 78 10 80       	mov    $0x801078e1,%eax
...
8010459e:	68 e5 78 10 80       	push   $0x801078e5
801045a3:	e8 08 c1 ff ff       	call   801006b0 <cprintf>
    if(p->state == SLEEPING){
...
801045dd:	68 21 76 10 80       	push   $0x80107621
801045e2:	e8 c9 c0 ff ff       	call   801006b0 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010460a:	68 18 79 10 80       	push   $0x80107918
...
8010464f:	e8 cc 02 00 00       	call   80104920 <acquire>
  while (lk->locked) {
...
80104665:	e8 66 fa ff ff       	call   801040d0 <sleep>
  while (lk->locked) {
...
80104673:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104679:	e8 02 f3 ff ff       	call   80103980 <myproc>
...
8010468c:	5d                   	pop    %ebp
  release(&lk->lk);
8010468d:	e9 2e 02 00 00       	jmp    801048c0 <release>
...
801046af:	e8 6c 02 00 00       	call   80104920 <acquire>
  lk->locked = 0;
...
801046c4:	e8 c7 fa ff ff       	call   80104190 <wakeup>
  release(&lk->lk);
801046c9:	83 c4 10             	add    $0x10,%esp
801046cc:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
801046d4:	5d                   	pop    %ebp
  release(&lk->lk);
801046d5:	e9 e6 01 00 00       	jmp    801048c0 <release>
...
801046f2:	e8 29 02 00 00       	call   80104920 <acquire>
...
80104704:	e8 b7 01 00 00       	call   801048c0 <release>
  return r;
}
...
80104711:	5d                   	pop    %ebp
80104712:	c3                   	ret
80104713:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  r = lk->locked && (lk->pid == myproc()->pid);
80104718:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
8010471b:	e8 60 f2 ff ff       	call   80103980 <myproc>
...
8010475d:	05 f8 ff ff 7f       	add    $0x7ffffff8,%eax
80104762:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
  for(i = 0; i < 10; i++){
80104767:	b8 00 00 00 00       	mov    $0x0,%eax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
8010476c:	76 10                	jbe    8010477e <getcallerpcs+0x2e>
8010476e:	eb 28                	jmp    80104798 <getcallerpcs+0x48>
80104770:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80104776:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
8010477c:	77 1a                	ja     80104798 <getcallerpcs+0x48>
      break;
...
8010478c:	75 e2                	jne    80104770 <getcallerpcs+0x20>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
80104798:	8d 04 81             	lea    (%ecx,%eax,4),%eax
8010479b:	83 c1 28             	add    $0x28,%ecx
8010479e:	89 ca                	mov    %ecx,%edx
801047a0:	29 c2                	sub    %eax,%edx
801047a2:	83 e2 04             	and    $0x4,%edx
801047a5:	74 11                	je     801047b8 <getcallerpcs+0x68>
    pcs[i] = 0;
801047a7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801047ad:	83 c0 04             	add    $0x4,%eax
801047b0:	39 c1                	cmp    %eax,%ecx
801047b2:	74 da                	je     8010478e <getcallerpcs+0x3e>
801047b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    pcs[i] = 0;
801047b8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801047be:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
801047c1:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
801047c8:	39 c1                	cmp    %eax,%ecx
801047ca:	75 ec                	jne    801047b8 <getcallerpcs+0x68>
801047cc:	eb c0                	jmp    8010478e <getcallerpcs+0x3e>
...
80104813:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010481a:	00 
...
80104865:	68 23 79 10 80       	push   $0x80107923
8010486a:	e8 11 bb ff ff       	call   80100380 <panic>
    panic("popcli");
8010486f:	83 ec 0c             	sub    $0xc,%esp
80104872:	68 3a 79 10 80       	push   $0x8010793a
...
801048db:	68 41 79 10 80       	push   $0x80107941
...
80104938:	0f 85 b2 00 00 00    	jne    801049f0 <acquire+0xd0>
  popcli();
8010493e:	e8 dd fe ff ff       	call   80104820 <popcli>
  asm volatile("lock; xchgl %0, %1" :
80104943:	b9 01 00 00 00       	mov    $0x1,%ecx
80104948:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010494f:	00 
  while(xchg(&lk->locked, 1) != 0)
80104950:	8b 55 08             	mov    0x8(%ebp),%edx
80104953:	89 c8                	mov    %ecx,%eax
80104955:	f0 87 02             	lock xchg %eax,(%edx)
80104958:	85 c0                	test   %eax,%eax
8010495a:	75 f4                	jne    80104950 <acquire+0x30>
  __sync_synchronize();
8010495c:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104961:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104964:	e8 97 ef ff ff       	call   80103900 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80104969:	8b 4d 08             	mov    0x8(%ebp),%ecx
  for(i = 0; i < 10; i++){
8010496c:	31 d2                	xor    %edx,%edx
  lk->cpu = mycpu();
8010496e:	89 43 08             	mov    %eax,0x8(%ebx)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104971:	8d 85 00 00 00 80    	lea    -0x80000000(%ebp),%eax
80104977:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
8010497c:	77 32                	ja     801049b0 <acquire+0x90>
  ebp = (uint*)v - 2;
8010497e:	89 e8                	mov    %ebp,%eax
80104980:	eb 14                	jmp    80104996 <acquire+0x76>
...
80104994:	77 1a                	ja     801049b0 <acquire+0x90>
    pcs[i] = ebp[1];     // saved %eip
80104996:	8b 58 04             	mov    0x4(%eax),%ebx
80104999:	89 5c 91 0c          	mov    %ebx,0xc(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
8010499d:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
801049a0:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801049a2:	83 fa 0a             	cmp    $0xa,%edx
801049a5:	75 e1                	jne    80104988 <acquire+0x68>
}
801049a7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801049aa:	c9                   	leave
801049ab:	c3                   	ret
801049ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801049b0:	8d 44 91 0c          	lea    0xc(%ecx,%edx,4),%eax
801049b4:	83 c1 34             	add    $0x34,%ecx
801049b7:	89 ca                	mov    %ecx,%edx
801049b9:	29 c2                	sub    %eax,%edx
801049bb:	83 e2 04             	and    $0x4,%edx
801049be:	74 10                	je     801049d0 <acquire+0xb0>
    pcs[i] = 0;
801049c0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801049c6:	83 c0 04             	add    $0x4,%eax
801049c9:	39 c1                	cmp    %eax,%ecx
801049cb:	74 da                	je     801049a7 <acquire+0x87>
801049cd:	8d 76 00             	lea    0x0(%esi),%esi
    pcs[i] = 0;
801049d0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801049d6:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
801049d9:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
801049e0:	39 c1                	cmp    %eax,%ecx
801049e2:	75 ec                	jne    801049d0 <acquire+0xb0>
801049e4:	eb c1                	jmp    801049a7 <acquire+0x87>
801049e6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801049ed:	00 
801049ee:	66 90                	xchg   %ax,%ax
  r = lock->locked && lock->cpu == mycpu();
801049f0:	8b 5b 08             	mov    0x8(%ebx),%ebx
801049f3:	e8 08 ef ff ff       	call   80103900 <mycpu>
801049f8:	39 c3                	cmp    %eax,%ebx
801049fa:	0f 85 3e ff ff ff    	jne    8010493e <acquire+0x1e>
  popcli();
80104a00:	e8 1b fe ff ff       	call   80104820 <popcli>
    panic("acquire");
80104a05:	83 ec 0c             	sub    $0xc,%esp
80104a08:	68 49 79 10 80       	push   $0x80107949
80104a0d:	e8 6e b9 ff ff       	call   80100380 <panic>
...
80104b01:	5d                   	pop    %ebp
80104b02:	c3                   	ret
80104b03:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104b0a:	00 
...
80104bbb:	89 ca                	mov    %ecx,%edx
80104bbd:	c6 40 ff 00          	movb   $0x0,-0x1(%eax)
  while(n-- > 0)
80104bc1:	29 c2                	sub    %eax,%edx
80104bc3:	85 d2                	test   %edx,%edx
80104bc5:	7f f1                	jg     80104bb8 <strncpy+0x48>
}
80104bc7:	5b                   	pop    %ebx
80104bc8:	89 f0                	mov    %esi,%eax
80104bca:	5e                   	pop    %esi
80104bcb:	5f                   	pop    %edi
80104bcc:	5d                   	pop    %ebp
80104bcd:	c3                   	ret
...
80104c47:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104c4a:	e8 31 ed ff ff       	call   80103980 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104c4f:	8b 00                	mov    (%eax),%eax
80104c51:	39 c3                	cmp    %eax,%ebx
80104c53:	73 1b                	jae    80104c70 <fetchint+0x30>
...
80104c87:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104c8a:	e8 f1 ec ff ff       	call   80103980 <myproc>

  if(addr >= curproc->sz)
80104c8f:	3b 18                	cmp    (%eax),%ebx
80104c91:	73 2d                	jae    80104cc0 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
...
80104cad:	73 11                	jae    80104cc0 <fetchstr+0x40>
    if(*s == 0)
...
80104cd5:	e8 a6 ec ff ff       	call   80103980 <myproc>
...
80104ce3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ce6:	e8 95 ec ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104d26:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104d29:	e8 52 ec ff ff       	call   80103980 <myproc>
...
80104d3e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104d41:	e8 3a ec ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104d62:	39 d0                	cmp    %edx,%eax
80104d64:	73 1a                	jae    80104d80 <argptr+0x60>
...
80104dbb:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104dbe:	e8 bd eb ff ff       	call   80103980 <myproc>
  if(addr >= curproc->sz)
...
80104de3:	39 d0                	cmp    %edx,%eax
80104de5:	73 11                	jae    80104df8 <argstr+0x68>
    if(*s == 0)
...
80104dff:	5d                   	pop    %ebp
80104e00:	c3                   	ret
80104e01:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104e08:	00 
...
80104e14:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104e17:	e8 64 eb ff ff       	call   80103980 <myproc>
...
80104e27:	83 fa 17             	cmp    $0x17,%edx
80104e2a:	77 24                	ja     80104e50 <syscall+0x40>
80104e2c:	8b 14 85 e0 7e 10 80 	mov    -0x7fef8120(,%eax,4),%edx
...
80104e44:	c9                   	leave
80104e45:	c3                   	ret
80104e46:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104e4d:	00 
...
80104e58:	68 51 79 10 80       	push   $0x80107951
80104e5d:	e8 4e b8 ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
...
80104fa4:	68 89 79 10 80       	push   $0x80107989
...
80104fbc:	68 88 79 10 80       	push   $0x80107988
...
8010500e:	e8 bd fc ff ff       	call   80104cd0 <argint>
...
8010508e:	e8 3d fc ff ff       	call   80104cd0 <argint>
...
801050b9:	e8 12 fc ff ff       	call   80104cd0 <argint>
...
801050ce:	e8 4d fc ff ff       	call   80104d20 <argptr>
...
8010510e:	e8 bd fb ff ff       	call   80104cd0 <argint>
...
80105139:	e8 92 fb ff ff       	call   80104cd0 <argint>
...
8010514e:	e8 cd fb ff ff       	call   80104d20 <argptr>
...
8010518e:	e8 3d fb ff ff       	call   80104cd0 <argint>
...
801051ee:	e8 dd fa ff ff       	call   80104cd0 <argint>
...
80105218:	e8 03 fb ff ff       	call   80104d20 <argptr>
...
80105278:	e8 13 fb ff ff       	call   80104d90 <argstr>
...
8010539f:	e8 ec f9 ff ff       	call   80104d90 <argstr>
...
801053dd:	58                   	pop    %eax
801053de:	5a                   	pop    %edx
801053df:	68 89 79 10 80       	push   $0x80107989
...
801053f8:	68 88 79 10 80       	push   $0x80107988
...
8010556f:	e8 1c f8 ff ff       	call   80104d90 <argstr>
...
80105729:	e8 a2 f5 ff ff       	call   80104cd0 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010573e:	e8 8d f5 ff ff       	call   80104cd0 <argint>
     argint(1, &major) < 0 ||
...
80105795:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105798:	e8 e3 e1 ff ff       	call   80103980 <myproc>
...
80105871:	e8 5a f4 ff ff       	call   80104cd0 <argint>
...
80105890:	e8 8b f1 ff ff       	call   80104a20 <memset>
...
801058ba:	e8 81 f3 ff ff       	call   80104c40 <fetchint>
...
801058d8:	e8 a3 f3 ff ff       	call   80104c80 <fetchstr>
...
80105941:	e8 da f3 ff ff       	call   80104d20 <argptr>
...
8010595c:	e8 bf da ff ff       	call   80103420 <pipealloc>
...
8010596b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010596d:	e8 0e e0 ff ff       	call   80103980 <myproc>
    if(curproc->ofile[fd] == 0){
...
80105997:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010599a:	e8 e1 df ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105a23:	83 ec 08             	sub    $0x8,%esp
  exit();
80105a26:	e8 e5 e3 ff ff       	call   80103e10 <exit>
...
{
  return wait();
80105a30:	e9 0b e5 ff ff       	jmp    80103f40 <wait>
...
80105a4c:	e8 7f f2 ff ff       	call   80104cd0 <argint>
...
80105a5e:	e8 8d e7 ff ff       	call   801041f0 <kill>
...
80105a9d:	e8 2e f2 ff ff       	call   80104cd0 <argint>
...
80105aed:	e8 de f1 ff ff       	call   80104cd0 <argint>
...
80105afc:	68 80 3d 11 80       	push   $0x80113d80
80105b01:	e8 1a ee ff ff       	call   80104920 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105b06:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105b09:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
...
80105b23:	68 80 3d 11 80       	push   $0x80113d80
80105b28:	68 60 3d 11 80       	push   $0x80113d60
80105b2d:	e8 9e e5 ff ff       	call   801040d0 <sleep>
  while(ticks - ticks0 < n){
80105b32:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
80105b50:	68 80 3d 11 80       	push   $0x80113d80
...
80105b73:	68 80 3d 11 80       	push   $0x80113d80
...
80105b94:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105b97:	68 80 3d 11 80       	push   $0x80113d80
80105b9c:	e8 7f ed ff ff       	call   80104920 <acquire>
  xticks = ticks;
80105ba1:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
80105ba7:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
...
80105bcc:	e8 ff f0 ff ff       	call   80104cd0 <argint>
80105bd1:	83 c4 10             	add    $0x10,%esp
80105bd4:	85 c0                	test   %eax,%eax
80105bd6:	78 18                	js     80105bf0 <sys_settickets+0x30>
    return -1;
  return settickets(n);
80105bd8:	83 ec 0c             	sub    $0xc,%esp
80105bdb:	ff 75 f4             	push   -0xc(%ebp)
80105bde:	e8 8d e6 ff ff       	call   80104270 <settickets>
...
80105c8e:	e8 8d f0 ff ff       	call   80104d20 <argptr>
80105c93:	83 c4 10             	add    $0x10,%esp
80105c96:	85 c0                	test   %eax,%eax
80105c98:	78 16                	js     80105cb0 <sys_join+0x30>
    return -1;
  return join(stack);
80105c9a:	83 ec 0c             	sub    $0xc,%esp
80105c9d:	ff 75 f4             	push   -0xc(%ebp)
80105ca0:	e8 5b e7 ff ff       	call   80104400 <join>
...
80105cf0:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
80105cf7:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
80105cfe:	08 00 00 8e 
80105d02:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105d09:	80 
80105d0a:	c1 ea 10             	shr    $0x10,%edx
80105d0d:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105d14:	80 
  for(i = 0; i < 256; i++)
...
80105d1f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105d22:	a1 0c a1 10 80       	mov    0x8010a10c,%eax
80105d27:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
80105d2e:	00 00 ef 
  initlock(&tickslock, "time");
80105d31:	68 ce 79 10 80       	push   $0x801079ce
80105d36:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105d3b:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105d41:	c1 e8 10             	shr    $0x10,%eax
80105d44:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
80105d4a:	e8 e1 e9 ff ff       	call   80104730 <initlock>
}
...
80105d6b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105d6f:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105db4:	ff 24 85 44 7f 10 80 	jmp    *-0x7fef80bc(,%eax,4)
...
80105df6:	e8 85 db ff ff       	call   80103980 <myproc>
...
80105dff:	0f 84 ab 00 00 00    	je     80105eb0 <trap+0x120>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e05:	e8 76 db ff ff       	call   80103980 <myproc>
80105e0a:	85 c0                	test   %eax,%eax
80105e0c:	74 1a                	je     80105e28 <trap+0x98>
80105e0e:	e8 6d db ff ff       	call   80103980 <myproc>
...
80105e85:	68 1c 7c 10 80       	push   $0x80107c1c
...
80105eb4:	0f 85 4b ff ff ff    	jne    80105e05 <trap+0x75>
    yield();
80105eba:	e8 c1 e1 ff ff       	call   80104080 <yield>
...
80105ed7:	68 c4 7b 10 80       	push   $0x80107bc4
...
80105f15:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105f18:	e8 f3 ee ff ff       	call   80104e10 <syscall>
    if(myproc()->killed)
...
80105f33:	5d                   	pop    %ebp
      exit();
80105f34:	e9 d7 de ff ff       	jmp    80103e10 <exit>
...
80105f95:	e8 86 e9 ff ff       	call   80104920 <acquire>
      ticks++;
80105f9a:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105fa1:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
80105fa8:	e8 e3 e1 ff ff       	call   80104190 <wakeup>
      release(&tickslock);
80105fad:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105fb4:	e8 07 e9 ff ff       	call   801048c0 <release>
...
80105ff3:	68 e8 7b 10 80       	push   $0x80107be8
80105ff8:	e8 b3 a6 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105ffd:	83 c4 14             	add    $0x14,%esp
80106000:	68 d3 79 10 80       	push   $0x801079d3
...
80106097:	0f 84 7c 00 00 00    	je     80106119 <uartinit+0xd9>
  uart = 1;
8010609d:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
801060a4:	00 00 00 
...
801060b0:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801060b3:	bf d8 79 10 80       	mov    $0x801079d8,%edi
...
801061a7:	6a 00                	push   $0x0
  jmp alltraps
801061a9:	e9 09 fb ff ff       	jmp    80105cb7 <alltraps>
...
801061b0:	6a 01                	push   $0x1
  jmp alltraps
801061b2:	e9 00 fb ff ff       	jmp    80105cb7 <alltraps>
...
801061b9:	6a 02                	push   $0x2
  jmp alltraps
801061bb:	e9 f7 fa ff ff       	jmp    80105cb7 <alltraps>
...
801061c2:	6a 03                	push   $0x3
  jmp alltraps
801061c4:	e9 ee fa ff ff       	jmp    80105cb7 <alltraps>
...
801061cb:	6a 04                	push   $0x4
  jmp alltraps
801061cd:	e9 e5 fa ff ff       	jmp    80105cb7 <alltraps>
...
801061d4:	6a 05                	push   $0x5
  jmp alltraps
801061d6:	e9 dc fa ff ff       	jmp    80105cb7 <alltraps>
...
801061dd:	6a 06                	push   $0x6
  jmp alltraps
801061df:	e9 d3 fa ff ff       	jmp    80105cb7 <alltraps>
...
801061e6:	6a 07                	push   $0x7
  jmp alltraps
801061e8:	e9 ca fa ff ff       	jmp    80105cb7 <alltraps>
...
801061ed:	6a 08                	push   $0x8
  jmp alltraps
801061ef:	e9 c3 fa ff ff       	jmp    80105cb7 <alltraps>
...
801061f6:	6a 09                	push   $0x9
  jmp alltraps
801061f8:	e9 ba fa ff ff       	jmp    80105cb7 <alltraps>
...
80106204:	6a 0b                	push   $0xb
  jmp alltraps
80106206:	e9 ac fa ff ff       	jmp    80105cb7 <alltraps>
...
8010620b:	6a 0c                	push   $0xc
  jmp alltraps
8010620d:	e9 a5 fa ff ff       	jmp    80105cb7 <alltraps>
...
80106212:	6a 0d                	push   $0xd
  jmp alltraps
80106214:	e9 9e fa ff ff       	jmp    80105cb7 <alltraps>
...
80106219:	6a 0e                	push   $0xe
  jmp alltraps
8010621b:	e9 97 fa ff ff       	jmp    80105cb7 <alltraps>
...
80106222:	6a 0f                	push   $0xf
  jmp alltraps
80106224:	e9 8e fa ff ff       	jmp    80105cb7 <alltraps>
...
8010623b:	6a 12                	push   $0x12
  jmp alltraps
8010623d:	e9 75 fa ff ff       	jmp    80105cb7 <alltraps>
...
80106244:	6a 13                	push   $0x13
  jmp alltraps
80106246:	e9 6c fa ff ff       	jmp    80105cb7 <alltraps>
...
8010624d:	6a 14                	push   $0x14
  jmp alltraps
8010624f:	e9 63 fa ff ff       	jmp    80105cb7 <alltraps>
...
80106256:	6a 15                	push   $0x15
  jmp alltraps
80106258:	e9 5a fa ff ff       	jmp    80105cb7 <alltraps>
...
8010625f:	6a 16                	push   $0x16
  jmp alltraps
80106261:	e9 51 fa ff ff       	jmp    80105cb7 <alltraps>
...
80106268:	6a 17                	push   $0x17
  jmp alltraps
8010626a:	e9 48 fa ff ff       	jmp    80105cb7 <alltraps>
...
80106271:	6a 18                	push   $0x18
  jmp alltraps
80106273:	e9 3f fa ff ff       	jmp    80105cb7 <alltraps>
...
8010627a:	6a 19                	push   $0x19
  jmp alltraps
8010627c:	e9 36 fa ff ff       	jmp    80105cb7 <alltraps>
...
80106283:	6a 1a                	push   $0x1a
  jmp alltraps
80106285:	e9 2d fa ff ff       	jmp    80105cb7 <alltraps>
...
8010628c:	6a 1b                	push   $0x1b
  jmp alltraps
8010628e:	e9 24 fa ff ff       	jmp    80105cb7 <alltraps>
...
80106295:	6a 1c                	push   $0x1c
  jmp alltraps
80106297:	e9 1b fa ff ff       	jmp    80105cb7 <alltraps>
...
8010629e:	6a 1d                	push   $0x1d
  jmp alltraps
801062a0:	e9 12 fa ff ff       	jmp    80105cb7 <alltraps>
...
801062a7:	6a 1e                	push   $0x1e
  jmp alltraps
801062a9:	e9 09 fa ff ff       	jmp    80105cb7 <alltraps>
...
801062b0:	6a 1f                	push   $0x1f
  jmp alltraps
801062b2:	e9 00 fa ff ff       	jmp    80105cb7 <alltraps>
...
801062b9:	6a 20                	push   $0x20
  jmp alltraps
801062bb:	e9 f7 f9 ff ff       	jmp    80105cb7 <alltraps>
...
801062c2:	6a 21                	push   $0x21
  jmp alltraps
801062c4:	e9 ee f9 ff ff       	jmp    80105cb7 <alltraps>
...
801062cb:	6a 22                	push   $0x22
  jmp alltraps
801062cd:	e9 e5 f9 ff ff       	jmp    80105cb7 <alltraps>
...
801062d4:	6a 23                	push   $0x23
  jmp alltraps
801062d6:	e9 dc f9 ff ff       	jmp    80105cb7 <alltraps>
...
801062dd:	6a 24                	push   $0x24
  jmp alltraps
801062df:	e9 d3 f9 ff ff       	jmp    80105cb7 <alltraps>
...
801062e6:	6a 25                	push   $0x25
  jmp alltraps
801062e8:	e9 ca f9 ff ff       	jmp    80105cb7 <alltraps>
...
801062ef:	6a 26                	push   $0x26
  jmp alltraps
801062f1:	e9 c1 f9 ff ff       	jmp    80105cb7 <alltraps>
...
801062f8:	6a 27                	push   $0x27
  jmp alltraps
801062fa:	e9 b8 f9 ff ff       	jmp    80105cb7 <alltraps>
...
80106301:	6a 28                	push   $0x28
  jmp alltraps
80106303:	e9 af f9 ff ff       	jmp    80105cb7 <alltraps>
...
8010630a:	6a 29                	push   $0x29
  jmp alltraps
8010630c:	e9 a6 f9 ff ff       	jmp    80105cb7 <alltraps>
...
80106313:	6a 2a                	push   $0x2a
  jmp alltraps
80106315:	e9 9d f9 ff ff       	jmp    80105cb7 <alltraps>
...
8010631c:	6a 2b                	push   $0x2b
  jmp alltraps
8010631e:	e9 94 f9 ff ff       	jmp    80105cb7 <alltraps>
...
80106325:	6a 2c                	push   $0x2c
  jmp alltraps
80106327:	e9 8b f9 ff ff       	jmp    80105cb7 <alltraps>
...
8010632e:	6a 2d                	push   $0x2d
  jmp alltraps
80106330:	e9 82 f9 ff ff       	jmp    80105cb7 <alltraps>
...
80106337:	6a 2e                	push   $0x2e
  jmp alltraps
80106339:	e9 79 f9 ff ff       	jmp    80105cb7 <alltraps>
...
80106340:	6a 2f                	push   $0x2f
  jmp alltraps
80106342:	e9 70 f9 ff ff       	jmp    80105cb7 <alltraps>
...
80106349:	6a 30                	push   $0x30
  jmp alltraps
8010634b:	e9 67 f9 ff ff       	jmp    80105cb7 <alltraps>
...
80106352:	6a 31                	push   $0x31
  jmp alltraps
80106354:	e9 5e f9 ff ff       	jmp    80105cb7 <alltraps>
...
8010635b:	6a 32                	push   $0x32
  jmp alltraps
8010635d:	e9 55 f9 ff ff       	jmp    80105cb7 <alltraps>
...
80106364:	6a 33                	push   $0x33
  jmp alltraps
80106366:	e9 4c f9 ff ff       	jmp    80105cb7 <alltraps>
...
8010636d:	6a 34                	push   $0x34
  jmp alltraps
8010636f:	e9 43 f9 ff ff       	jmp    80105cb7 <alltraps>
...
80106376:	6a 35                	push   $0x35
  jmp alltraps
80106378:	e9 3a f9 ff ff       	jmp    80105cb7 <alltraps>
...
8010637f:	6a 36                	push   $0x36
  jmp alltraps
80106381:	e9 31 f9 ff ff       	jmp    80105cb7 <alltraps>
...
80106388:	6a 37                	push   $0x37
  jmp alltraps
8010638a:	e9 28 f9 ff ff       	jmp    80105cb7 <alltraps>
...
80106391:	6a 38                	push   $0x38
  jmp alltraps
80106393:	e9 1f f9 ff ff       	jmp    80105cb7 <alltraps>
...
8010639a:	6a 39                	push   $0x39
  jmp alltraps
8010639c:	e9 16 f9 ff ff       	jmp    80105cb7 <alltraps>
...
801063a3:	6a 3a                	push   $0x3a
  jmp alltraps
801063a5:	e9 0d f9 ff ff       	jmp    80105cb7 <alltraps>
...
801063ac:	6a 3b                	push   $0x3b
  jmp alltraps
801063ae:	e9 04 f9 ff ff       	jmp    80105cb7 <alltraps>
...
801063b5:	6a 3c                	push   $0x3c
  jmp alltraps
801063b7:	e9 fb f8 ff ff       	jmp    80105cb7 <alltraps>
...
801063be:	6a 3d                	push   $0x3d
  jmp alltraps
801063c0:	e9 f2 f8 ff ff       	jmp    80105cb7 <alltraps>
...
801063c7:	6a 3e                	push   $0x3e
  jmp alltraps
801063c9:	e9 e9 f8 ff ff       	jmp    80105cb7 <alltraps>
...
801063d0:	6a 3f                	push   $0x3f
  jmp alltraps
801063d2:	e9 e0 f8 ff ff       	jmp    80105cb7 <alltraps>
...
801063d9:	6a 40                	push   $0x40
  jmp alltraps
801063db:	e9 d7 f8 ff ff       	jmp    80105cb7 <alltraps>
...
801063e2:	6a 41                	push   $0x41
  jmp alltraps
801063e4:	e9 ce f8 ff ff       	jmp    80105cb7 <alltraps>
...
801063eb:	6a 42                	push   $0x42
  jmp alltraps
801063ed:	e9 c5 f8 ff ff       	jmp    80105cb7 <alltraps>
...
801063f4:	6a 43                	push   $0x43
  jmp alltraps
801063f6:	e9 bc f8 ff ff       	jmp    80105cb7 <alltraps>
...
801063fd:	6a 44                	push   $0x44
  jmp alltraps
801063ff:	e9 b3 f8 ff ff       	jmp    80105cb7 <alltraps>
...
80106406:	6a 45                	push   $0x45
  jmp alltraps
80106408:	e9 aa f8 ff ff       	jmp    80105cb7 <alltraps>
...
8010640f:	6a 46                	push   $0x46
  jmp alltraps
80106411:	e9 a1 f8 ff ff       	jmp    80105cb7 <alltraps>
...
80106418:	6a 47                	push   $0x47
  jmp alltraps
8010641a:	e9 98 f8 ff ff       	jmp    80105cb7 <alltraps>
...
80106421:	6a 48                	push   $0x48
  jmp alltraps
80106423:	e9 8f f8 ff ff       	jmp    80105cb7 <alltraps>
...
8010642a:	6a 49                	push   $0x49
  jmp alltraps
8010642c:	e9 86 f8 ff ff       	jmp    80105cb7 <alltraps>
...
80106433:	6a 4a                	push   $0x4a
  jmp alltraps
80106435:	e9 7d f8 ff ff       	jmp    80105cb7 <alltraps>
...
8010643c:	6a 4b                	push   $0x4b
  jmp alltraps
8010643e:	e9 74 f8 ff ff       	jmp    80105cb7 <alltraps>
...
80106445:	6a 4c                	push   $0x4c
  jmp alltraps
80106447:	e9 6b f8 ff ff       	jmp    80105cb7 <alltraps>
...
8010644e:	6a 4d                	push   $0x4d
  jmp alltraps
80106450:	e9 62 f8 ff ff       	jmp    80105cb7 <alltraps>
...
80106457:	6a 4e                	push   $0x4e
  jmp alltraps
80106459:	e9 59 f8 ff ff       	jmp    80105cb7 <alltraps>
...
80106460:	6a 4f                	push   $0x4f
  jmp alltraps
80106462:	e9 50 f8 ff ff       	jmp    80105cb7 <alltraps>
...
80106469:	6a 50                	push   $0x50
  jmp alltraps
8010646b:	e9 47 f8 ff ff       	jmp    80105cb7 <alltraps>
...
80106472:	6a 51                	push   $0x51
  jmp alltraps
80106474:	e9 3e f8 ff ff       	jmp    80105cb7 <alltraps>
...
8010647b:	6a 52                	push   $0x52
  jmp alltraps
8010647d:	e9 35 f8 ff ff       	jmp    80105cb7 <alltraps>
...
80106484:	6a 53                	push   $0x53
  jmp alltraps
80106486:	e9 2c f8 ff ff       	jmp    80105cb7 <alltraps>
...
8010648d:	6a 54                	push   $0x54
  jmp alltraps
8010648f:	e9 23 f8 ff ff       	jmp    80105cb7 <alltraps>
...
80106496:	6a 55                	push   $0x55
  jmp alltraps
80106498:	e9 1a f8 ff ff       	jmp    80105cb7 <alltraps>
...
8010649f:	6a 56                	push   $0x56
  jmp alltraps
801064a1:	e9 11 f8 ff ff       	jmp    80105cb7 <alltraps>
...
801064a8:	6a 57                	push   $0x57
  jmp alltraps
801064aa:	e9 08 f8 ff ff       	jmp    80105cb7 <alltraps>
...
801064b1:	6a 58                	push   $0x58
  jmp alltraps
801064b3:	e9 ff f7 ff ff       	jmp    80105cb7 <alltraps>
...
801064ba:	6a 59                	push   $0x59
  jmp alltraps
801064bc:	e9 f6 f7 ff ff       	jmp    80105cb7 <alltraps>
...
801064c3:	6a 5a                	push   $0x5a
  jmp alltraps
801064c5:	e9 ed f7 ff ff       	jmp    80105cb7 <alltraps>
...
801064cc:	6a 5b                	push   $0x5b
  jmp alltraps
801064ce:	e9 e4 f7 ff ff       	jmp    80105cb7 <alltraps>
...
801064d5:	6a 5c                	push   $0x5c
  jmp alltraps
801064d7:	e9 db f7 ff ff       	jmp    80105cb7 <alltraps>
...
801064de:	6a 5d                	push   $0x5d
  jmp alltraps
801064e0:	e9 d2 f7 ff ff       	jmp    80105cb7 <alltraps>
...
801064e7:	6a 5e                	push   $0x5e
  jmp alltraps
801064e9:	e9 c9 f7 ff ff       	jmp    80105cb7 <alltraps>
...
801064f0:	6a 5f                	push   $0x5f
  jmp alltraps
801064f2:	e9 c0 f7 ff ff       	jmp    80105cb7 <alltraps>
...
801064f9:	6a 60                	push   $0x60
  jmp alltraps
801064fb:	e9 b7 f7 ff ff       	jmp    80105cb7 <alltraps>
...
80106502:	6a 61                	push   $0x61
  jmp alltraps
80106504:	e9 ae f7 ff ff       	jmp    80105cb7 <alltraps>
...
8010650b:	6a 62                	push   $0x62
  jmp alltraps
8010650d:	e9 a5 f7 ff ff       	jmp    80105cb7 <alltraps>
...
80106514:	6a 63                	push   $0x63
  jmp alltraps
80106516:	e9 9c f7 ff ff       	jmp    80105cb7 <alltraps>
...
8010651d:	6a 64                	push   $0x64
  jmp alltraps
8010651f:	e9 93 f7 ff ff       	jmp    80105cb7 <alltraps>
...
80106526:	6a 65                	push   $0x65
  jmp alltraps
80106528:	e9 8a f7 ff ff       	jmp    80105cb7 <alltraps>
...
8010652f:	6a 66                	push   $0x66
  jmp alltraps
80106531:	e9 81 f7 ff ff       	jmp    80105cb7 <alltraps>
...
80106538:	6a 67                	push   $0x67
  jmp alltraps
8010653a:	e9 78 f7 ff ff       	jmp    80105cb7 <alltraps>
...
80106541:	6a 68                	push   $0x68
  jmp alltraps
80106543:	e9 6f f7 ff ff       	jmp    80105cb7 <alltraps>
...
8010654a:	6a 69                	push   $0x69
  jmp alltraps
8010654c:	e9 66 f7 ff ff       	jmp    80105cb7 <alltraps>
...
80106553:	6a 6a                	push   $0x6a
  jmp alltraps
80106555:	e9 5d f7 ff ff       	jmp    80105cb7 <alltraps>
...
8010655c:	6a 6b                	push   $0x6b
  jmp alltraps
8010655e:	e9 54 f7 ff ff       	jmp    80105cb7 <alltraps>
...
80106565:	6a 6c                	push   $0x6c
  jmp alltraps
80106567:	e9 4b f7 ff ff       	jmp    80105cb7 <alltraps>
...
8010656e:	6a 6d                	push   $0x6d
  jmp alltraps
80106570:	e9 42 f7 ff ff       	jmp    80105cb7 <alltraps>
...
80106577:	6a 6e                	push   $0x6e
  jmp alltraps
80106579:	e9 39 f7 ff ff       	jmp    80105cb7 <alltraps>
...
80106580:	6a 6f                	push   $0x6f
  jmp alltraps
80106582:	e9 30 f7 ff ff       	jmp    80105cb7 <alltraps>
...
80106589:	6a 70                	push   $0x70
  jmp alltraps
8010658b:	e9 27 f7 ff ff       	jmp    80105cb7 <alltraps>
...
80106592:	6a 71                	push   $0x71
  jmp alltraps
80106594:	e9 1e f7 ff ff       	jmp    80105cb7 <alltraps>
...
8010659b:	6a 72                	push   $0x72
  jmp alltraps
8010659d:	e9 15 f7 ff ff       	jmp    80105cb7 <alltraps>
...
801065a4:	6a 73                	push   $0x73
  jmp alltraps
801065a6:	e9 0c f7 ff ff       	jmp    80105cb7 <alltraps>
...
801065ad:	6a 74                	push   $0x74
  jmp alltraps
801065af:	e9 03 f7 ff ff       	jmp    80105cb7 <alltraps>
...
801065b6:	6a 75                	push   $0x75
  jmp alltraps
801065b8:	e9 fa f6 ff ff       	jmp    80105cb7 <alltraps>
...
801065bf:	6a 76                	push   $0x76
  jmp alltraps
801065c1:	e9 f1 f6 ff ff       	jmp    80105cb7 <alltraps>
...
801065c8:	6a 77                	push   $0x77
  jmp alltraps
801065ca:	e9 e8 f6 ff ff       	jmp    80105cb7 <alltraps>
...
801065d1:	6a 78                	push   $0x78
  jmp alltraps
801065d3:	e9 df f6 ff ff       	jmp    80105cb7 <alltraps>
...
801065da:	6a 79                	push   $0x79
  jmp alltraps
801065dc:	e9 d6 f6 ff ff       	jmp    80105cb7 <alltraps>
...
801065e3:	6a 7a                	push   $0x7a
  jmp alltraps
801065e5:	e9 cd f6 ff ff       	jmp    80105cb7 <alltraps>
...
801065ec:	6a 7b                	push   $0x7b
  jmp alltraps
801065ee:	e9 c4 f6 ff ff       	jmp    80105cb7 <alltraps>
...
801065f5:	6a 7c                	push   $0x7c
  jmp alltraps
801065f7:	e9 bb f6 ff ff       	jmp    80105cb7 <alltraps>
...
801065fe:	6a 7d                	push   $0x7d
  jmp alltraps
80106600:	e9 b2 f6 ff ff       	jmp    80105cb7 <alltraps>
...
80106607:	6a 7e                	push   $0x7e
  jmp alltraps
80106609:	e9 a9 f6 ff ff       	jmp    80105cb7 <alltraps>
...
80106610:	6a 7f                	push   $0x7f
  jmp alltraps
80106612:	e9 a0 f6 ff ff       	jmp    80105cb7 <alltraps>
...
80106619:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010661e:	e9 94 f6 ff ff       	jmp    80105cb7 <alltraps>
...
80106625:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010662a:	e9 88 f6 ff ff       	jmp    80105cb7 <alltraps>
...
80106631:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106636:	e9 7c f6 ff ff       	jmp    80105cb7 <alltraps>
...
8010663d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106642:	e9 70 f6 ff ff       	jmp    80105cb7 <alltraps>
...
80106649:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010664e:	e9 64 f6 ff ff       	jmp    80105cb7 <alltraps>
...
80106655:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010665a:	e9 58 f6 ff ff       	jmp    80105cb7 <alltraps>
...
80106661:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106666:	e9 4c f6 ff ff       	jmp    80105cb7 <alltraps>
...
8010666d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106672:	e9 40 f6 ff ff       	jmp    80105cb7 <alltraps>
...
80106679:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010667e:	e9 34 f6 ff ff       	jmp    80105cb7 <alltraps>
...
80106685:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010668a:	e9 28 f6 ff ff       	jmp    80105cb7 <alltraps>
...
80106691:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106696:	e9 1c f6 ff ff       	jmp    80105cb7 <alltraps>
...
8010669d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801066a2:	e9 10 f6 ff ff       	jmp    80105cb7 <alltraps>
...
801066a9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801066ae:	e9 04 f6 ff ff       	jmp    80105cb7 <alltraps>
...
801066b5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801066ba:	e9 f8 f5 ff ff       	jmp    80105cb7 <alltraps>
...
801066c1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801066c6:	e9 ec f5 ff ff       	jmp    80105cb7 <alltraps>
...
801066cd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801066d2:	e9 e0 f5 ff ff       	jmp    80105cb7 <alltraps>
...
801066d9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801066de:	e9 d4 f5 ff ff       	jmp    80105cb7 <alltraps>
...
801066e5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801066ea:	e9 c8 f5 ff ff       	jmp    80105cb7 <alltraps>
...
801066f1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801066f6:	e9 bc f5 ff ff       	jmp    80105cb7 <alltraps>
...
801066fd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106702:	e9 b0 f5 ff ff       	jmp    80105cb7 <alltraps>
...
80106709:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010670e:	e9 a4 f5 ff ff       	jmp    80105cb7 <alltraps>
...
80106715:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010671a:	e9 98 f5 ff ff       	jmp    80105cb7 <alltraps>
...
80106721:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106726:	e9 8c f5 ff ff       	jmp    80105cb7 <alltraps>
...
8010672d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106732:	e9 80 f5 ff ff       	jmp    80105cb7 <alltraps>
...
80106739:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010673e:	e9 74 f5 ff ff       	jmp    80105cb7 <alltraps>
...
80106745:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010674a:	e9 68 f5 ff ff       	jmp    80105cb7 <alltraps>
...
80106751:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106756:	e9 5c f5 ff ff       	jmp    80105cb7 <alltraps>
...
8010675d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106762:	e9 50 f5 ff ff       	jmp    80105cb7 <alltraps>
...
80106769:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010676e:	e9 44 f5 ff ff       	jmp    80105cb7 <alltraps>
...
80106775:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010677a:	e9 38 f5 ff ff       	jmp    80105cb7 <alltraps>
...
80106781:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106786:	e9 2c f5 ff ff       	jmp    80105cb7 <alltraps>
...
8010678d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106792:	e9 20 f5 ff ff       	jmp    80105cb7 <alltraps>
...
80106799:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010679e:	e9 14 f5 ff ff       	jmp    80105cb7 <alltraps>
...
801067a5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801067aa:	e9 08 f5 ff ff       	jmp    80105cb7 <alltraps>
...
801067b1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801067b6:	e9 fc f4 ff ff       	jmp    80105cb7 <alltraps>
...
801067bd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801067c2:	e9 f0 f4 ff ff       	jmp    80105cb7 <alltraps>
...
801067c9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801067ce:	e9 e4 f4 ff ff       	jmp    80105cb7 <alltraps>
...
801067d5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801067da:	e9 d8 f4 ff ff       	jmp    80105cb7 <alltraps>
...
801067e1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801067e6:	e9 cc f4 ff ff       	jmp    80105cb7 <alltraps>
...
801067ed:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801067f2:	e9 c0 f4 ff ff       	jmp    80105cb7 <alltraps>
...
801067f9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801067fe:	e9 b4 f4 ff ff       	jmp    80105cb7 <alltraps>
...
80106805:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010680a:	e9 a8 f4 ff ff       	jmp    80105cb7 <alltraps>
...
80106811:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106816:	e9 9c f4 ff ff       	jmp    80105cb7 <alltraps>
...
8010681d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106822:	e9 90 f4 ff ff       	jmp    80105cb7 <alltraps>
...
80106829:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010682e:	e9 84 f4 ff ff       	jmp    80105cb7 <alltraps>
...
80106835:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010683a:	e9 78 f4 ff ff       	jmp    80105cb7 <alltraps>
...
80106841:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106846:	e9 6c f4 ff ff       	jmp    80105cb7 <alltraps>
...
8010684d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106852:	e9 60 f4 ff ff       	jmp    80105cb7 <alltraps>
...
80106859:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010685e:	e9 54 f4 ff ff       	jmp    80105cb7 <alltraps>
...
80106865:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010686a:	e9 48 f4 ff ff       	jmp    80105cb7 <alltraps>
...
80106871:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106876:	e9 3c f4 ff ff       	jmp    80105cb7 <alltraps>
...
8010687d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106882:	e9 30 f4 ff ff       	jmp    80105cb7 <alltraps>
...
80106889:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010688e:	e9 24 f4 ff ff       	jmp    80105cb7 <alltraps>
...
80106895:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010689a:	e9 18 f4 ff ff       	jmp    80105cb7 <alltraps>
...
801068a1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801068a6:	e9 0c f4 ff ff       	jmp    80105cb7 <alltraps>
...
801068ad:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801068b2:	e9 00 f4 ff ff       	jmp    80105cb7 <alltraps>
...
801068b9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801068be:	e9 f4 f3 ff ff       	jmp    80105cb7 <alltraps>
...
801068c5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801068ca:	e9 e8 f3 ff ff       	jmp    80105cb7 <alltraps>
...
801068d1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801068d6:	e9 dc f3 ff ff       	jmp    80105cb7 <alltraps>
...
801068dd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801068e2:	e9 d0 f3 ff ff       	jmp    80105cb7 <alltraps>
...
801068e9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801068ee:	e9 c4 f3 ff ff       	jmp    80105cb7 <alltraps>
...
801068f5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801068fa:	e9 b8 f3 ff ff       	jmp    80105cb7 <alltraps>
...
80106901:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106906:	e9 ac f3 ff ff       	jmp    80105cb7 <alltraps>
...
8010690d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106912:	e9 a0 f3 ff ff       	jmp    80105cb7 <alltraps>
...
80106919:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010691e:	e9 94 f3 ff ff       	jmp    80105cb7 <alltraps>
...
80106925:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010692a:	e9 88 f3 ff ff       	jmp    80105cb7 <alltraps>
...
80106931:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106936:	e9 7c f3 ff ff       	jmp    80105cb7 <alltraps>
...
8010693d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106942:	e9 70 f3 ff ff       	jmp    80105cb7 <alltraps>
...
80106949:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010694e:	e9 64 f3 ff ff       	jmp    80105cb7 <alltraps>
...
80106955:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010695a:	e9 58 f3 ff ff       	jmp    80105cb7 <alltraps>
...
80106961:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106966:	e9 4c f3 ff ff       	jmp    80105cb7 <alltraps>
...
8010696d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106972:	e9 40 f3 ff ff       	jmp    80105cb7 <alltraps>
...
80106979:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010697e:	e9 34 f3 ff ff       	jmp    80105cb7 <alltraps>
...
80106985:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010698a:	e9 28 f3 ff ff       	jmp    80105cb7 <alltraps>
...
80106991:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106996:	e9 1c f3 ff ff       	jmp    80105cb7 <alltraps>
...
8010699d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801069a2:	e9 10 f3 ff ff       	jmp    80105cb7 <alltraps>
...
801069a9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801069ae:	e9 04 f3 ff ff       	jmp    80105cb7 <alltraps>
...
801069b5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801069ba:	e9 f8 f2 ff ff       	jmp    80105cb7 <alltraps>
...
801069c1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801069c6:	e9 ec f2 ff ff       	jmp    80105cb7 <alltraps>
...
801069cd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801069d2:	e9 e0 f2 ff ff       	jmp    80105cb7 <alltraps>
...
801069d9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801069de:	e9 d4 f2 ff ff       	jmp    80105cb7 <alltraps>
...
801069e5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801069ea:	e9 c8 f2 ff ff       	jmp    80105cb7 <alltraps>
...
801069f1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801069f6:	e9 bc f2 ff ff       	jmp    80105cb7 <alltraps>
...
801069fd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106a02:	e9 b0 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a09:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106a0e:	e9 a4 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a15:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106a1a:	e9 98 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a21:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106a26:	e9 8c f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a2d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106a32:	e9 80 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a39:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106a3e:	e9 74 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a45:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106a4a:	e9 68 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a51:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106a56:	e9 5c f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a5d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106a62:	e9 50 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a69:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106a6e:	e9 44 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a75:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106a7a:	e9 38 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a81:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106a86:	e9 2c f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a8d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106a92:	e9 20 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106a99:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106a9e:	e9 14 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106aa5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106aaa:	e9 08 f2 ff ff       	jmp    80105cb7 <alltraps>
...
80106ab1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106ab6:	e9 fc f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106abd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106ac2:	e9 f0 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106ac9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106ace:	e9 e4 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106ad5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106ada:	e9 d8 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106ae1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106ae6:	e9 cc f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106aed:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106af2:	e9 c0 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106af9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106afe:	e9 b4 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b05:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106b0a:	e9 a8 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b11:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106b16:	e9 9c f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b1d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106b22:	e9 90 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b29:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106b2e:	e9 84 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b35:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106b3a:	e9 78 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b41:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106b46:	e9 6c f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b4d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106b52:	e9 60 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b59:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106b5e:	e9 54 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b65:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106b6a:	e9 48 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b71:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106b76:	e9 3c f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b7d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106b82:	e9 30 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b89:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106b8e:	e9 24 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106b95:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106b9a:	e9 18 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106ba1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106ba6:	e9 0c f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106bad:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106bb2:	e9 00 f1 ff ff       	jmp    80105cb7 <alltraps>
...
80106bb9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106bbe:	e9 f4 f0 ff ff       	jmp    80105cb7 <alltraps>
...
80106bc5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106bca:	e9 e8 f0 ff ff       	jmp    80105cb7 <alltraps>
...
80106bd1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106bd6:	e9 dc f0 ff ff       	jmp    80105cb7 <alltraps>
...
80106bdd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106be2:	e9 d0 f0 ff ff       	jmp    80105cb7 <alltraps>
...
80106be9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106bee:	e9 c4 f0 ff ff       	jmp    80105cb7 <alltraps>
...
80106bf5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106bfa:	e9 b8 f0 ff ff       	jmp    80105cb7 <alltraps>
...
80106c01:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106c06:	e9 ac f0 ff ff       	jmp    80105cb7 <alltraps>
...
80106c0d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106c12:	e9 a0 f0 ff ff       	jmp    80105cb7 <alltraps>
...
80106d77:	e8 a4 dc ff ff       	call   80104a20 <memset>
...
80106dbd:	68 e0 79 10 80       	push   $0x801079e0
...
80106dea:	c7 80 18 18 11 80 ff 	movl   $0xffff,-0x7feee7e8(%eax)
80106df1:	ff 00 00 
80106df4:	c7 80 1c 18 11 80 00 	movl   $0xcf9a00,-0x7feee7e4(%eax)
80106dfb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106dfe:	c7 80 20 18 11 80 ff 	movl   $0xffff,-0x7feee7e0(%eax)
80106e05:	ff 00 00 
80106e08:	c7 80 24 18 11 80 00 	movl   $0xcf9200,-0x7feee7dc(%eax)
80106e0f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106e12:	c7 80 28 18 11 80 ff 	movl   $0xffff,-0x7feee7d8(%eax)
80106e19:	ff 00 00 
80106e1c:	c7 80 2c 18 11 80 00 	movl   $0xcffa00,-0x7feee7d4(%eax)
80106e23:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106e26:	c7 80 30 18 11 80 ff 	movl   $0xffff,-0x7feee7d0(%eax)
80106e2d:	ff 00 00 
80106e30:	c7 80 34 18 11 80 00 	movl   $0xcff200,-0x7feee7cc(%eax)
80106e37:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106e3a:	05 10 18 11 80       	add    $0x80111810,%eax
  pd[1] = (uint)p;
...
80106e60:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106e94:	0f 84 c2 00 00 00    	je     80106f5c <switchuvm+0xec>
  pushcli();
80106e9a:	e8 31 d9 ff ff       	call   801047d0 <pushcli>
...
80106fe0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106fe1:	e9 ca da ff ff       	jmp    80104ab0 <memmove>
    panic("inituvm: more than a page");
80106fe6:	83 ec 0c             	sub    $0xc,%esp
80106fe9:	68 25 7a 10 80       	push   $0x80107a25
...
80107038:	68 3f 7a 10 80       	push   $0x80107a3f
...
801070c0:	68 60 7c 10 80       	push   $0x80107c60
...
8010711b:	e8 00 d9 ff ff       	call   80104a20 <memset>
...
8010715d:	68 5d 7a 10 80       	push   $0x80107a5d
...
801071a3:	68 75 7a 10 80       	push   $0x80107a75
...
8010728c:	68 91 7a 10 80       	push   $0x80107a91
...
801072c0:	e8 5b d7 ff ff       	call   80104a20 <memset>
...
8010732b:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010735c:	68 a2 7a 10 80       	push   $0x80107aa2
...
801073d2:	68 ac 7a 10 80       	push   $0x80107aac
...
80107430:	e8 7b d6 ff ff       	call   80104ab0 <memmove>
...
801074a7:	68 c6 7a 10 80       	push   $0x80107ac6
...
80107560:	e8 4b d5 ff ff       	call   80104ab0 <memmove>
    len -= n;
    buf += n;
