   ...
   f:	31 db                	xor    %ebx,%ebx
{
  ...
  int tickets[] = {10, 20, 30};
  15:	c7 45 dc 0a 00 00 00 	movl   $0xa,-0x24(%ebp)
  printf(1, "Lottery test starting\n");
  1c:	68 98 07 00 00       	push   $0x798
  21:	6a 01                	push   $0x1
  int tickets[] = {10, 20, 30};
  23:	c7 45 e0 14 00 00 00 	movl   $0x14,-0x20(%ebp)
  2a:	c7 45 e4 1e 00 00 00 	movl   $0x1e,-0x1c(%ebp)
  printf(1, "Lottery test starting\n");
  31:	e8 5a 04 00 00       	call   490 <printf>
  36:	83 c4 10             	add    $0x10,%esp
    pid = fork();
  39:	e8 ed 02 00 00       	call   32b <fork>
    if(pid < 0){
  3e:	85 c0                	test   %eax,%eax
  40:	78 2d                	js     6f <main+0x6f>
      printf(1, "fork failed\n");
      exit();
    }
    if(pid == 0){
  42:	74 3e                	je     82 <main+0x82>
  for(i = 0; i < 3; i++){
  44:	83 c3 01             	add    $0x1,%ebx
  47:	83 fb 03             	cmp    $0x3,%ebx
  4a:	75 ed                	jne    39 <main+0x39>
      exit();
    }
  }
  ...
  56:	e8 e0 02 00 00       	call   33b <wait>
  }
  ...
  exit();
  6a:	e8 c4 02 00 00       	call   333 <exit>
      printf(1, "fork failed\n");
  6f:	50                   	push   %eax
  70:	50                   	push   %eax
  71:	68 af 07 00 00       	push   $0x7af
  76:	6a 01                	push   $0x1
  78:	e8 13 04 00 00       	call   490 <printf>
      exit();
  7d:	e8 b1 02 00 00       	call   333 <exit>
      settickets(tickets[i]);
  82:	8b 74 9d dc          	mov    -0x24(%ebp,%ebx,4),%esi
  86:	83 ec 0c             	sub    $0xc,%esp
  89:	56                   	push   %esi
  8a:	e8 44 03 00 00       	call   3d3 <settickets>
      printf(1, "Child %d started with %d tickets\n", i, tickets[i]);
  8f:	56                   	push   %esi
  90:	53                   	push   %ebx
  91:	68 f4 07 00 00       	push   $0x7f4
  96:	6a 01                	push   $0x1
  98:	e8 f3 03 00 00       	call   490 <printf>
  9d:	83 c4 20             	add    $0x20,%esp
  a0:	b8 00 e1 f5 05       	mov    $0x5f5e100,%eax
      double x = 0;
  a5:	d9 ee                	fldz
        x += 1.1;
  a7:	dd 05 18 08 00 00    	fldl   0x818
  ad:	8d 76 00             	lea    0x0(%esi),%esi
  b0:	dc c1                	fadd   %st,%st(1)
  b2:	dc c1                	fadd   %st,%st(1)
      for(int j = 0; j < 100000000; j++){
  b4:	83 e8 02             	sub    $0x2,%eax
  b7:	75 f7                	jne    b0 <main+0xb0>
  b9:	dd d8                	fstp   %st(0)
      printf(1, "Child %d finished (x=%d)\n", i, (int)x);
  bb:	d9 7d d6             	fnstcw -0x2a(%ebp)
  be:	0f b7 45 d6          	movzwl -0x2a(%ebp),%eax
  c2:	80 cc 0c             	or     $0xc,%ah
  c5:	66 89 45 d4          	mov    %ax,-0x2c(%ebp)
  c9:	d9 6d d4             	fldcw  -0x2c(%ebp)
  cc:	db 5d d0             	fistpl -0x30(%ebp)
  cf:	d9 6d d6             	fldcw  -0x2a(%ebp)
  d2:	8b 45 d0             	mov    -0x30(%ebp),%eax
  d5:	50                   	push   %eax
  d6:	53                   	push   %ebx
  d7:	68 bc 07 00 00       	push   $0x7bc
  dc:	6a 01                	push   $0x1
 ...
 499:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 610:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 615:	bb ed 07 00 00       	mov    $0x7ed,%ebx
...
free(void *ap)
{
 ...
 621:	a1 1c 0b 00 00       	mov    0xb1c,%eax
{
 ...
 65f:	5b                   	pop    %ebx
  freep = p;
 660:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 667:	5d                   	pop    %ebp
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 1c 0b 00 00       	mov    %eax,0xb1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 1c 0b 00 00    	mov    0xb1c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6fb:	3b 05 1c 0b 00 00    	cmp    0xb1c,%eax
 ...
 71e:	e8 fd fe ff ff       	call   620 <free>
  return freep;
 723:	8b 15 1c 0b 00 00    	mov    0xb1c,%edx
 ...
 74c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 74f:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
}
 ...
 75f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 1c 0b 00 00 20 	movl   $0xb20,0xb1c
 767:	0b 00 00 
    base.s.size = 0;
 76a:	b8 20 0b 00 00       	mov    $0xb20,%eax
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 20 0b 00 00 20 	movl   $0xb20,0xb20
 776:	0b 00 00 
    base.s.size = 0;
 779:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 780:	00 00 00 
    if(p->s.size >= nunits){
